...
export default async function AdminDashboardPage() {
  ...
  return (
    <div className="p-6 lg:p-8">
      ...
      <div className="mb-6 grid grid-cols-1 gap-4 sm:grid-cols-3">
        ...
        <div className="flex flex-col justify-between rounded-2xl bg-white p-6 shadow-[0_2px_20px_rgba(0,0,0,0.05)]">
          ...
          <div className="mt-3 flex flex-wrap gap-1.5">
            ...
            <span className="rounded-full bg-gray-50 px-2.5 py-0.5 text-[0.65rem] font-semibold text-gray-400">Ready to export</span>
          </div>
        </div>
      ...
      {/* Table */}
      <DashboardTable reports={normalized} deleteReportAction={deleteReport} />
    </div>
  );
}
